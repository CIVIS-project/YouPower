 ...
 */
router.get('/facebook',passport.authenticate('facebook',{scope:['user_friends','email'],session: false}),function(req, res){
});
 ...
 * @apiGroup Facebook Login
 */
router.get('/facebookc',passport.authorize('facebook-authz',{scope:'email',session: false}),function(req, res){
});
 ...
 * @apiGroup Facebook Login
 */
router.get('/facebook/callbackfb',passport.authorize('facebook-authz',{session: false}),function(req, res) {
